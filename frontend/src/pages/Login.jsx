      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[1fr_1.5fr]">
        ...
        <section className="flex items-center justify-center px-6 py-10 sm:px-8">
          <div className="w-full max-w-[520px] rounded-[24px] bg-[#ede6f7] p-8 shadow-[0_18px_50px_rgba(52,20,99,0.08)] sm:p-10">
            <div>
              <h2 className="text-5xl font-semibold tracking-tight text-[#1c1b26]">Welcome back</h2>
              <p className="mt-4 text-2xl text-[#595668]">Sign in to access your card library</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-1 w-full rounded-xl bg-gradient-to-r from-[#5f16bf] to-[#8b3efb] py-3 text-2xl font-semibold text-white shadow-[0_10px_24px_rgba(99,38,184,0.28)] transition hover:brightness-105 disabled:opacity-50"
              >
                {loading ? 'Logging in...' : 'Login'}
              </button>

              <p className="pt-3 text-center text-2xl text-[#4b4859]">
